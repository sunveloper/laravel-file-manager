		...
		<div class="modal-body p-0">
			...
			<div class="data-info">
				<div class="data-info-body p-3">
					...
					<a href="javascript:void(0)" class="tx-danger tx-14 btn-link-delete" v-on:click="activeModalDelete">Delete File</a>
				</div>
				...
				<div class="data-info-footer p-3 border-top d-flex justify-content-between">
					...
					<button type="button" class="btn btn-outline-primary btn-tool wd-100 py-2 px-0 mx-2" v-on:click="activeModalRename">
...
<script>
	...
	export default {
		...
		mounted() {
			...
			axios.get('https://b2b-core-develop.ecslab.dev/api/admin/storage/all').then((response) => {
