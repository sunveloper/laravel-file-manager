<template>
	<div class="modal-content fm-modal-properties flex-md-row">
		...
		<div class="modal-body p-0">
			...
			<div class="data-info">
				<div class="data-info-body p-3">
					<div class="name mb-3">
						<label class="form-label tx-gray-600 mb-0 tx-medium">{{
					...
					<a
						...
						class="tx-danger tx-14 btn-link-delete"
						v-on:click="activeModalDelete"
						>Delete File</a
					>
				</div>
				...
				<div class="data-info-footer p-3 border-top d-flex justify-content-between">
					<button
						type="button"
						class="btn btn-outline-primary btn-tool wd-100 py-2 px-0"
						v-on:click="downloadAction()"
						v-bind:disabled="selectedItem.type == 'dir'"
					>
					...
					<button
						type="button"
						class="btn btn-outline-primary btn-tool wd-100 py-2 px-0 mx-2"
						v-on:click="activeModalRename"
					>
					...
					<button
						...
						v-bind:disabled="!url || selectedItem.type == 'dir'"
					>
		...
		<div
			class="fm-modal fm-modal-level_2"
			ref="fmModal"
			v-on:click="inActiveModalDelete"
			v-if="modalDelete"
		>
				...
				<div class="modal-content fm-modal-delete">
					<div class="modal-body text-center flex-column">
						...
						<p
							class="
								form-label
								tx-13 tx-gray-600 tx-medium
								message
								m-0
							"
						>
							This will delete your item. Are you sure?
						</p>
					</div>
					<div class="modal-footer">
						<button
							class="btn btn-outline-light flex-1 mr-1"
							v-on:click="inActiveModalDelete"
						>
							{{ lang.btn.cancel }}
						</button>
						<button
							class="btn btn-outline-danger flex-1 ml-1"
				...
				<div class="modal-content fm-modal-rename">
					...
					<div class="modal-body">
						<div class="form-group mb-0 w-100">
							<label
								for="fm-input-rename"
								class="form-label tx-gray-600 mb-2 tx-medium"
								>{{ lang.modal.rename.fieldName }}</label
							>
							<input
								type="text"
								class="form-control"
					...
					<div class="modal-footer justify-content-between">
						<button
							class="btn btn-outline-light flex-1 mr-1"
							v-on:click="inActiveModalRename"
						>
							{{ lang.btn.cancel }}
						</button>
						<button
							class="btn btn-primary flex-1 ml-1"
